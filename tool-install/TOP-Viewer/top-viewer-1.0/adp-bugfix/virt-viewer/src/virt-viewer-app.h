...
gboolean virt_viewer_app_get_disable_inputs(VirtViewerApp *self);
gboolean virt_viewer_app_get_resize_guest(VirtViewerApp *self);
gboolean virt_viewer_app_get_scaling(VirtViewerApp *self);
gboolean virt_viewer_app_get_auto_clipboard(VirtViewerApp *self);
gchar * virt_viewer_app_get_preferred_compression(VirtViewerApp *self);
gchar * virt_viewer_app_get_video_codec(VirtViewerApp *self);
...
void virt_viewer_app_show_report(const char * report);
