...
void virt_viewer_window_change_watermark(VirtViewerWindow *self, const gchar* label);
//void virt_viewer_window_change_watermark_to_static(guint interval);
...
static guint watermark_status = 1;
static gfloat watermark_x = 0.0;//x
static gfloat watermark_y = 0.0;//y
