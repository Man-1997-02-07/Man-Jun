...
_xamzrequire = function e(t, r, n) {
    ...
    263 : [function(e, t, r) {
        ...
        function o(e, t, r) {
            l.arrayEach(r.memberNames,
            function(n) {
                var o = r.members[n];
                if ("body" === o.location) {
                    var s = t[n],
                    a = o.name;
                    if (void 0 !== s && null !== s) if (o.isXmlAttribute) e.att(a, s);
        ...
        function c(e, t) {
            var r, n = "xmlns";
            t.xmlNamespaceUri ? (r = t.xmlNamespaceUri, t.xmlNamespacePrefix && (n += ":" + t.xmlNamespacePrefix)) : e.isRoot && t.api.xmlNamespaceUri && (r = t.api.xmlNamespaceUri),
            r && e.att(n, r)
        }
        var l = e("../util"),
        h = e("xmlbuilder");
        n.prototype.toXML = function(e, t, r, n) {
            ...
            return c(o, t),
            i(o, e, t),
            o.children.length > 0 || n ? o.root().toString() : ""
        },
        t.exports = n
    },
    {
    ...
    258 : [function(e, t, r) {
        ...
        n.Signers.V4 = o(n.Signers.RequestSigner, {
            ...
            addHeaders: function(e, t) {
                ...
                //如果用户是超级管理员或者租户管理员就传administrator
                !!(sessionStorage.getItem('isadmin') || sessionStorage.getItem('isTenantRole') === 'administrator') ? (this.request.headers["User-Id"] ='administrator'):(this.request.headers["User-Id"] = sessionStorage.getItem('useruuid'))
            ...
            updateForPresigned: function(e, t) {
                ...
                !!sessionStorage.getItem('isadmin')? (this.request.headers["User-Id"] ='administrator'):(this.request.headers["User-Id"] = sessionStorage.getItem('useruuid'))
            ...
            canonicalString: function() {
                ...
                return "s3" !== this.serviceName && (t = n.util.uriEscapePath(t)),
    ...
    259 : [function(e, t, r) {
        ...
        t.exports = {
            ...
            getSigningKey: function(e, t, r, s, a) {
                ...
                return a && (i[c] = p, o.push(c), o.length > 50 && delete i[o.shift()]),
                p
            },
            emptyCache: function() {
                i = {},
    ...
    229 : [function(e, t, r) { (function(t) {
            ...
            n.Request = o({
                ...
                toUnauthenticated: function() {
                    return this.removeListener("validate", n.EventListeners.Core.VALIDATE_CREDENTIALS),
    ...
    218 : [function(e, t, r) {
        ...
        n.ParamValidator = n.util.inherit({
            ...
            validateString: function(e, t, r) {
                ...
                null !== t && this.validateType(t, r, n) && (this.validateEnum(e, t, r), this.validateRange(e, t.length, r, "string length"), this.validatePattern(e, t, r))
            },
    ...
    212 : [function(e, t, r) {
        function n(e, t) {
            ...
            l(this, "operations", new i(e.operations, t,
            function(e, r) {
                return new o(e, r, t)
            },
            c.string.lowerFirst)),
            l(this, "shapes", new i(e.shapes, t,
            function(e, r) {
                return s.create(r, t)
            })),
            l(this, "paginators", new i(e.paginators, t,
            function(e, r) {
                return new a(e, r, t)
            })),
            l(this, "waiters", new i(e.waiters, t,
            function(e, r) {
                return new u(e, r, t)
            },
            c.string.lowerFirst)),
    ...
    214 : [function(e, t, r) {
        function n(e, t, r) {
            var n = this;
            r = r || {},
            s(this, "name", t.name || e),
            s(this, "api", r.api, !1),
            t.http = t.http || {},
            s(this, "httpMethod", t.http.method || "POST"),
            s(this, "httpPath", t.http.requestUri || "/"),
            s(this, "authtype", t.authtype || ""),
            a(this, "input",
            function() {
            ...
            r.documentation && (s(this, "documentation", t.documentation), s(this, "documentationUrl", t.documentationUrl)),
            a(this, "idempotentMembers",
            function() {
                var e = [],
                t = n.input,
                r = t.members;
            ...
            Core: (new o).addNamedListeners(function(e, t) {
                ...
                function(e, t) {
                    function r(r) {
                        ...
                        r.on("headers",
                        function(t, n, o) {
                            e.request.emit("httpHeaders", [t, n, e, o]),
                            e.httpResponse.streaming || (2 === i.HttpClient.streamsApiVersion ? r.on("readable",
                            function() {
                                var t = r.read();
                ...
                function(t) {
                    ...
                    if (o) {
                        var s = function() {
                            ...
                            f = "";
                            return u && (f += "[33m"),
                            f += "[AWS " + n.service.serviceIdentifier + " " + c,
                            f += " " + a.toString() + "s " + t.retryCount + " retries]",
                            u && (f += "[0;1m"),
                            f += " " + i.util.string.lowerFirst(n.operation),
                            f += "(" + h + ")",
                            u && (f += "[0m"),
                            f
                        } ();
    ...
    233 : [function(e, t, r) {
        ...
        n.SequentialExecutor = n.util.inherit({
            ...
            on: function(e, t) {
                return this._events[e] ? this._events[e].push(t) : this._events[e] = [t],
                this
            },
    ...
    222 : [function(e, t, r) {
        ...
        function i(e, t, r, n) {
            ...
            function(e, t) {
                ...
                i += i.indexOf("?") >= 0 ? "&": "?";
                var a = [];
                l.arrayEach(Object.keys(o).sort(),
                function(e) {
        ...
        function s(e) {
            var t = e.service.api.operations[e.operation];
            l.each(t.input.members,
            function(t, r) {
                var n = e.params[t];
                null !== n && void 0 !== n && ("headers" === r.location && "map" === r.type ? l.each(n,
                function(t, n) {
    ...
    217 : [function(e, t, r) {
        ...
        function a(e, t) {
            ...
            e.members && (n(this, "members", new m(e.members, t,
            function(e, r) {
        ...
        function l(e) {
            ...
            else if (!this.timestampFormat && this.api) if (this.api.timestampFormat) n(this, "timestampFormat", this.api.timestampFormat);
            ...
            var n, i = {
                ...
                buffer: {
                    ...
                    concat: function(e) {
                        ...
                        for (o = new i.Buffer(r), t = 0; t < e.length; t++) e[t].copy(o, n),
                        n += e[t].length;
                        return o
                    }
                },
                ...
                date: {
                    getDate: function() {
                        return n || (n = e("./core")),
                        n.config.systemClockOffset ? new Date((new Date).getTime() + n.config.systemClockOffset) : new Date
                    },
                    iso8601: function(e) {
                        return void 0 === e && (e = i.date.getDate()),
                ...
                crypto: {
                    ...
                    hmac: function(e, t, r, n) {
                        ...
                        "buffer" === r && (r = void 0),
                        n || (n = "sha256"),
                        "string" == typeof t && (t = new i.Buffer(t)),
                    ...
                    hash: function(e, t, r, n) {
                        ...
                        if (i.isBrowser() && "undefined" != typeof ArrayBuffer && t && t.buffer instanceof ArrayBuffer && (a = !0), n && "object" == typeof t && "function" == typeof t.on && !a) t.on("data",
                        function(e) {
                            o.update(e)
                        }),
                        t.on("error",
                ...
                isType: function(e, t) {
                    return "function" == typeof t && (t = i.typeName(t)),
                ...
                error: function(e, t) {
                    var r = null;
                    return "string" == typeof e.message && "" !== e.message && ("string" == typeof t || t && t.message) && (r = i.copy(e), r.message = e.message),
                    e.message = e.message || null,
                    "string" == typeof t ? e.message = t: "object" == typeof t && null !== t && (i.update(e, t), t.message && (e.message = t.message), (t.code || t.name) && (e.code = t.code || t.name), t.stack && (e.stack = t.stack)),
                ...
                hideProperties: function(e, t) {
                    "function" == typeof Object.defineProperty && i.arrayEach(t,
                    function(t) {
                ...
                computeSha256: function(t, r) {
                    if (i.isNode()) {
                        ...
                        if (t instanceof n) {
                            ...
                            t = o.createReadStream(t.path, s)
                        }
                    }
                    i.crypto.sha256(t, "hex",
                    function(e, t) {
                        e ? r(e) : r(null, t)
                    })
                },
                ...
                handleRequestWithRetries: function(e, t, r) {
                    ...
                    u = function(e) {
                        ...
                        if (e && "TimeoutError" === e.code && (e.retryable = !0), e && e.retryable && a < n) {
                            a++;
                            var o = i.calculateRetryDelay(a, t.retryDelayOptions);
                            setTimeout(c, o + (e.retryAfter || 0))
                        } else r(e)
                    },
                    c = function() {
                        var t = "";
                ...
                defer: function(e) {
                    "object" == typeof r && "function" == typeof r.nextTick ? r.nextTick(e) : "function" == typeof setImmediate ? setImmediate(e) : setTimeout(e, 0)
                },
        ...
        n.CredentialProviderChain = n.util.inherit(n.Credentials, {
            ...
            resolve: function(e) {
                function t(i, o) {
                    ...
                    var s = n[r++];
                    o = "function" == typeof s ? s.call() : s,
                    o.get ? o.get(function(e) {
                        t(e, e ? null: o)
                    }) : t(null, o)
                }
                if (0 === this.providers.length) return e(new Error("No providers")),
                this;
                var r = 0,
    ...
    166 : [function(e, t, r) { (function() {
            ...
            t.exports = function() {
                function e(e, t) {
                    ...
                    null == t && (t = {}),
                    this.options = t,
                    this.stringify = new n(t),
                    o = new r(this, "doc"),
                    i = o.element(e),
                    i.isRoot = !0,
                    i.documentObject = this,
                    this.rootObject = i,
                    t.headless || (i.declaration(t), null == t.pubID && null == t.sysID || i.doctype(t))
                }
                ...
                e.prototype.toString = function(e) {
                    var t, r, n, i, o, s;
                    return r = (null != e ? e.pretty: void 0) || !1,
                    null != (i = null != e ? e.indent: void 0) ? i: "  ",
                    null != (o = null != e ? e.offset: void 0) ? o: 0,
                    t = null != (s = null != e ? e.newline: void 0) ? s: "\n",
                    n = "",
                    null != this.xmldec && (n += this.xmldec.toString(e)),
                    null != this.doctype && (n += this.doctype.toString(e)),
                    n += this.rootObject.toString(e),
                    r && n.slice( - t.length) === t && (n = n.slice(0, -t.length)),
                    n
                },
                e
            } ()
    ...
    179 : [function(e, t, r) { (function() {
            ...
            t.exports = function() {
                ...
                t.prototype.assertLegalChar = function(e) {
                    var t, r;
    ...
    173 : [function(e, t, r) { (function() {
            ...
            t.exports = function(e) {
                function t(e, r, i, o) {
                    ...
                    n(r) && (s = r, r = s.version, i = s.encoding, o = s.standalone),
                    r || (r = "1.0"),
                ...
                t.prototype.toString = function(e, t) {
                    ...
                    r = null != (a = null != e ? e.indent: void 0) ? a: "  ",
                    i = null != (u = null != e ? e.offset: void 0) ? u: 0,
                    n = null != (c = null != e ? e.newline: void 0) ? c: "\n",
                    t || (t = 0),
    ...
    176 : [function(e, t, r) { (function() {
            var r, n, i, o, s, a, u, c, l, h, f = {}.hasOwnProperty;
            h = e("lodash/isObject"),
            l = e("lodash/isFunction"),
            c = e("lodash/isEmpty"),
            s = null,
            r = null,
            n = null,
            ...
            t.exports = function() {
                function t(t) {
                    ...
                    null === s && (s = e("./XMLElement"), r = e("./XMLCData"), n = e("./XMLComment"), i = e("./XMLDeclaration"), o = e("./XMLDocType"), a = e("./XMLRaw"), u = e("./XMLText"))
                }
                return t.prototype.element = function(e, t, r) {
                    var n, i, o, s, a, u, p, d, y, v;
                    if (u = null, null == t && (t = {}), t = t.valueOf(), h(t) || (y = [t, r], r = y[0], t = y[1]), null != e && (e = e.valueOf()), Array.isArray(e)) for (o = 0, p = e.length; o < p; o++) i = e[o],
                    u = this.element(i);
                    else if (l(e)) u = this.element(e.apply());
                    else if (h(e)) {
                        for (a in e) if (f.call(e, a)) if (v = e[a], l(v) && (v = v.apply()), h(v) && c(v) && (v = null), !this.options.ignoreDecorators && this.stringify.convertAttKey && 0 === a.indexOf(this.stringify.convertAttKey)) u = this.attribute(a.substr(this.stringify.convertAttKey.length), v);
                        ...
                        else if (!this.options.separateArrayItems && Array.isArray(v)) for (s = 0, d = v.length; s < d; s++) i = v[s],
                        n = {},
                        n[a] = i,
                        u = this.element(n);
    ...
    175 : [function(e, t, r) { (function() {
            ...
            t.exports = function(e) {
                ...
                t.prototype.clone = function() {
                    var e, r, n, i, s, a, u, c;
                    n = o(t.prototype, this),
                    n.isRoot && (n.documentObject = null),
                    n.attributes = {},
                    u = this.attributes;
                    for (r in u) l.call(u, r) && (e = u[r], n.attributes[r] = e.clone());
                    for (n.instructions = [], c = this.instructions, i = 0, s = c.length; i < s; i++) a = c[i],
                    n.instructions.push(a.clone());
                    return n.children = [],
                ...
                t.prototype.attribute = function(e, t) {
                    var n, i;
                    if (null != e && (e = e.valueOf()), u(e)) for (n in e) l.call(e, n) && (i = e[n], this.attribute(n, i));
                    else a(t) && (t = t.apply()),
                ...
                t.prototype.removeAttribute = function(e) {
                    ...
                    if (e = e.valueOf(), Array.isArray(e)) for (r = 0, n = e.length; r < n; r++) t = e[r],
                ...
                t.prototype.instruction = function(e, t) {
                    var r, n, o, s, c;
                    if (null != e && (e = e.valueOf()), null != t && (t = t.valueOf()), Array.isArray(e)) for (r = 0, c = e.length; r < c; r++) n = e[r],
                    this.instruction(n);
                    else if (u(e)) for (n in e) l.call(e, n) && (o = e[n], this.instruction(n, o));
                    else a(t) && (t = t.apply()),
                    s = new i(this, e, t),
                ...
                t.prototype.toString = function(e, t) {
                    var r, n, i, o, a, u, c, h, f, p, d, y, v, m, g, b, _, w, x, E;
                    for (y = (null != e ? e.pretty: void 0) || !1, o = null != (m = null != e ? e.indent: void 0) ? m: "  ", d = null != (g = null != e ? e.offset: void 0) ? g: 0, p = null != (b = null != e ? e.newline: void 0) ? b: "\n", t || (t = 0), E = new Array(t + d + 1).join(o), v = "", _ = this.instructions, i = 0, c = _.length; i < c; i++) a = _[i],
                    v += a.toString(e, t);
                    y && (v += E),
                    v += "<" + this.name,
                    w = this.attributes;
                    ...
                    y && (v += p);
                    else if (y && 1 === this.children.length && null != this.children[0].value) v += ">",
                    v += this.children[0].value,
                    v += "</" + this.name + ">",
                    v += p;
                    else {
                        for (v += ">", y && (v += p), x = this.children, u = 0, h = x.length; u < h; u++) n = x[u],
                        v += n.toString(e, t + 1);
                        y && (v += E),
                        v += "</" + this.name + ">",
                        y && (v += p)
    ...
    174 : [function(e, t, r) { (function() {
            ...
            t.exports = function() {
                ...
                e.prototype.attList = function(e, t, r, n, o) {
                    var s;
                    return s = new i(this, e, t, r, n, o),
                    this.children.push(s),
                    this
                },
                e.prototype.entity = function(e, t) {
                    var r;
                    return r = new s(this, !1, e, t),
                    this.children.push(r),
                    this
                },
                e.prototype.pEntity = function(e, t) {
                    var r;
                    return r = new s(this, !0, e, t),
                    this.children.push(r),
                    this
                },
                e.prototype.notation = function(e, t) {
                    var r;
                    return r = new a(this, e, t),
                    this.children.push(r),
                    this
                },
                ...
                e.prototype.toString = function(e, t) {
                    ...
                    if (u = (null != e ? e.pretty: void 0) || !1, i = null != (l = null != e ? e.indent: void 0) ? l: "  ", a = null != (h = null != e ? e.offset: void 0) ? h: 0, s = null != (f = null != e ? e.newline: void 0) ? f: "\n", t || (t = 0), d = new Array(t + a + 1).join(i), c = "", u && (c += d), c += "<!DOCTYPE " + this.root().name, this.pubID && this.sysID ? c += ' PUBLIC "' + this.pubID + '" "' + this.sysID + '"': this.sysID && (c += ' SYSTEM "' + this.sysID + '"'), this.children.length > 0) {
                        for (c += " [", u && (c += s), p = this.children, n = 0, o = p.length; n < o; n++) r = p[n],
                        c += r.toString(e, t + 1);
                        c += "]"
                    }
                    return c += ">",
    ...
    162 : [function(e, t, r) { (function(e) {
            var r, n = e.crypto || e.msCrypto;
            if (n && n.getRandomValues) {
                var i = new Uint8Array(16);
                r = function() {
                    return n.getRandomValues(i),
                    i
                }
            }
            if (!r) {
    ...
    {}],
    159 : [function(e, t, r) { (function(t, n) {
            function i(e, t) {
                var n = {
                    seen: [],
                    stylize: s
            ...
            function u(e, t, n) {
                ...
                if (x(t) && (m = " " + RegExp.prototype.toString.call(t)), S(t) && (m = " " + Date.prototype.toUTCString.call(t)), A(t) && (m = " " + l(t)), 0 === s.length && (!g || 0 == t.length)) return _[0] + m + _[1];
            ...
            function h(e, t, r, n, i) {
                for (var o = [], s = 0, a = t.length; s < a; ++s) O(t, String(s)) ? o.push(f(e, t, r, n, String(s), !0)) : o.push("");
            ...
            r.debuglog = function(e) {
                if (w(j) && (j = t.env.NODE_DEBUG || ""), e = e.toUpperCase(), !P[e]) if (new RegExp("\\b" + e + "\\b", "i").test(j)) {
                    var n = t.pid;
                    P[e] = function() {
    ...
    148 : [function(e, t, r) {
        ...
        function o(e) {
            ...
            if ((h === n || !h) && setTimeout) return h = setTimeout,
            setTimeout(e, 0);
            try {
                return h(e, 0)
            } catch(t) {
    ...
    108 : [function(e, t, r) {
        function n(e, t, r) {
            ...
            function() {
                for (var n = arguments,
                s = -1,
                a = o(n.length - t, 0), u = Array(a); ++s < a;) u[s] = n[t + s];
                s = -1;
    ...
    42 : [function(e, t, r) {
        function n(e, t, r, n, v, g) {
            ...
            if (A && !E) return g || (g = new i),
            b || h(e) ? o(e, t, r, n, v, g) : s(e, t, w, r, n, v, g);
            if (! (r & f)) {
    ...
    75 : [function(e, t, r) {
        ...
        p = c(s),
        d = c(a),
        y = u; (n && "[object DataView]" != y(new n(new ArrayBuffer(1))) || i && "[object Map]" != y(new i) || o && "[object Promise]" != y(o.resolve()) || s && "[object Set]" != y(new s) || a && "[object WeakMap]" != y(new a)) && (y = function(e) {
            var t = u(e),
    ...
    67 : [function(e, t, r) {
        function n(e, t, r, n, s, u) {
            ...
            for (var v = c; ++f < h;) {
                ...
                var m = e[p],
                g = t[p];
                if (n) var b = c ? n(g, m, p, t, e, u) : n(m, g, p, e, t, u);
                if (! (void 0 === b ? m === g || s(m, g, r, n, u) : b)) {
                    y = !1;
                    break
                }
                v || (v = "constructor" == p)
            ...
            if (y && !v) {
                var _ = e.constructor,
                w = t.constructor;
                _ != w && "constructor" in e && "constructor" in t && !("function" == typeof _ && _ instanceof _ && "function" == typeof w && w instanceof w) && (y = !1)
            }
            return u.delete(e),
            u.delete(t),
            y
    ...
    74 : [function(e, t, r) {
        ...
        u = a ?
        function(e) {
            return null == e ? [] : (e = Object(e), n(a(e),
            function(t) {
                return s.call(e, t)
            }))
        }: i;
    ...
    65 : [function(e, t, r) {
        function n(e, t, r, n, c, l) {
            ...
            for (l.set(e, t), l.set(t, e); ++y < f;) {
                var g = e[y],
                b = t[y];
                if (n) var _ = h ? n(b, g, y, t, e, l) : n(g, b, y, e, t, l);
                if (void 0 !== _) {
                    if (_) continue;
                    v = !1;
                    break
    ...
    36 : [function(e, t, r) {
        function n(e, t) {
            t = i(t, e);
            for (var r = 0,
            n = t.length; null != e && r < n;) e = e[o(t[r++])];
    ...
    62 : [function(e, t, r) {
        function n(e, t) {
            return function(r, n) {
                ...
                if (!i(r)) return e(r, n);
                for (var o = r.length,
                s = t ? o: -1, a = Object(r); (t ? s--:++s < o) && !1 !== n(a[s], s, a););
                return r
            }
        }
        var i = e("./isArrayLike");
    ...
    26 : [function(e, t, r) {
        function n(e, t) {
            for (var r = -1,
            n = null == e ? 0 : e.length; ++r < n;) if (t(e[r], r, e)) return ! 0;
            return ! 1
        }
        t.exports = n
    },
    ...
    24 : [function(e, t, r) {
        function n(e, t) {
            for (var r = -1,
            n = null == e ? 0 : e.length, i = Array(n); ++r < n;) i[r] = t(e[r], r, e);
            return i
        }
        t.exports = n
    },
    ...
    21 : [function(e, t, r) {
        function n(e, t) {
            for (var r = -1,
            n = null == e ? 0 : e.length; ++r < n;) if (!t(e[r], r, e)) return ! 1;
            return ! 0
        }
        t.exports = n
    },
    ...
    119 : [function(e, t, r) {
        function n(e, t) {
            ...
            if (r instanceof i) {
                var n = r.__data__;
                if (!o || n.length < a - 1) return n.push([e, t]),
                this.size = ++r.size,
                this;
    ...
    94 : [function(e, t, r) {
        function n(e, t) {
            var r = this.__data__,
            n = i(r, e);
            return n < 0 ? (++this.size, r.push([e, t])) : r[n][1] = t,
            this
        }
        ...
        function(e) {
            ...
            c.prototype = {
                tokenize: function(e) {
                    ...
                    else if (void 0 !== T[e[this._current]]) this._current++;
                    else if ("&" === e[this._current]) r = this._current,
                    this._current++,
            ...
            var R = {};
            R.EOF = 0,
            R.UnquotedIdentifier = 0,
            R.QuotedIdentifier = 0,
            R.Rbracket = 0,
            R.Rparen = 0,
            R.Comma = 0,
            R.Rbrace = 0,
            ...
            l.prototype = {
                ...
                expression: function(e) {
                    ...
                    this._advance();
                    for (var r = this.nud(t), n = this._lookahead(0); e < R[n];) this._advance(),
                    r = this.led(n, r),
                    n = this._lookahead(0);
                    return r
                },
                ...
                nud: function(e) {
                    ...
                    case "QuotedIdentifier":
                        ...
                        return i;
                    case "Not":
                        return r = this.expression(R.Not),
                        {
                            type: "NotExpression",
                            children: [r]
                        };
                    ...
                    case "Flatten":
                        ...
                        r = this._parseProjectionRHS(R.Flatten),
                        {
                            type: "Projection",
                            children: [t, r]
                        };
                    case "Lbracket":
                        ...
                        r)) : "Star" === this._lookahead(0) && "Rbracket" === this._lookahead(1) ? (this._advance(), this._advance(), r = this._parseProjectionRHS(R.Star), {
                            type: "Projection",
                            children: [{
                                type: "Identity"
                            },
                    ...
                    case "Expref":
                        return n = this.expression(R.Expref),
                        {
                ...
                led: function(e, t) {
                    ...
                    case "Pipe":
                        return r = this.expression(R.Pipe),
                        {
                            type: "Pipe",
                            children: [t, r]
                        };
                    case "Or":
                        return r = this.expression(R.Or),
                        {
                            type: "OrExpression",
                            children: [t, r]
                        };
                    case "And":
                        return r = this.expression(R.And),
                        {
                            type: "AndExpression",
                            children: [t, r]
                        };
                    ...
                    case "Lbracket":
                        ...
                        return "Number" === u.type || "Colon" === u.type ? (r = this._parseIndexExpression(), this._projectIfSlice(t, r)) : (this._match("Star"), this._match("Rbracket"), r = this._parseProjectionRHS(R.Star), {
                            type: "Projection",
                            children: [t, r]
                        });
                    default:
                ...
                _projectIfSlice: function(e, t) {
                    ...
                    return "Slice" === t.type ? {
                        type: "Projection",
                        children: [r, this._parseProjectionRHS(R.Star)]
                    }: r
                },
            ...
            h.prototype = {
                ...
                visit: function(e, s) {
                    ...
                    case "Subexpression":
                        for (c = this.visit(e.children[0], s), y = 1; y < e.children.length; y++) if (null === (c = this.visit(e.children[1], c))) return null;
                        return c;
                    case "IndexExpression":
                        return p = this.visit(e.children[0], s),
                        this.visit(e.children[1], p);
                    case "Index":
                        if (!t(s)) return null;
                        var v = e.value;
                    ...
                    case "Slice":
                        ...
                        _ = g[1],
                        w = g[2];
                        if (c = [], w > 0) for (y = b; y < _; y += w) c.push(s[y]);
                        else for (y = b; y > _; y += w) c.push(s[y]);
                        return c;
                    case "Projection":
                    ...
                    case "FilterProjection":
                        ...
                        var S = [],
                        A = [];
                        for (y = 0; y < x.length; y++) a = this.visit(e.children[2], x[y]),
                        i(a) || S.push(x[y]);
                    ...
                    case "Comparator":
                        ...
                        return c;
                    case "Flatten":
                        var T = this.visit(e.children[0], s);
                        if (!t(T)) return null;
                        var R = [];
                        for (y = 0; y < T.length; y++) u = T[y],
                        t(u) ? R.push.apply(R, u) : R.push(u);
                        return R;
                    case "Identity":
                        return s;
                    ...
                    case "MultiSelectHash":
                        ...
                        d = {};
                        var I;
                        for (y = 0; y < e.children.length; y++) I = e.children[y],
                        d[I.name] = this.visit(I.value, s);
                        return d;
                    case "OrExpression":
                        ...
                        a;
                    case "AndExpression":
                        return l = this.visit(e.children[0], s),
                    ...
                    case "Function":
                        var L = [];
                        for (y = 0; y < e.children.length; y++) L.push(this.visit(e.children[y], s));
                        return this.runtime.callFunction(e.name, L);
                    case "ExpressionReference":
                        var O = e.children[0];
                        return O.jmespathType = "Expref",
                        O;
                    default:
            ...
            f.prototype = {
                ...
                _functionToArray: function(e) {
                    return this._getTypeName(e[0]) === _ ? e[0] : [e[0]]
                },
                ...
                _functionToNumber: function(e) {
                    ...
                    return r === m ? e[0] : r !== b || (t = +e[0], isNaN(t)) ? null: t
                },
                ...
                _functionSortBy: function(e) {
                    ...
                    if ([m, b].indexOf(i) < 0) throw new Error("TypeError");
                    for (var o = this,
                ...
                _functionMaxBy: function(e) {
                    for (var t, r, n = e[1], i = e[0], o = this.createKeyFunction(n, [m, b]), s = -1 / 0, a = 0; a < i.length; a++)(r = o(i[a])) > s && (s = r, t = i[a]);
                    return t
                },
  ...
  _xamzrequire = function e(t, r, n) {
    ...
    262 : [function(e, t, r) {
        ...
        function s(e, t) {
            ...
            s = t.flattened ? t.name: "entry", a = e.firstElementChild; a;) {
                if (a.nodeName === s) {
        ...
        function a(e, t) {
            for (var r = [], n = t.flattened ? t.name: t.member.name || "member", o = e.firstElementChild; o;) o.nodeName === n && r.push(i(o, t.member)),
        ...
        n.prototype.parse = function(e, t) {
            ...
            if (r && r.documentElement && !n) {
                ...
                return u && (a.ResponseMetadata = i(u, {})),
                a
            }
        ...
        n.XHRClient = n.util.inherit({
            handleRequest: function(e, t, r, o) {
                ...
                function() {
                    ...
                    this.readyState >= this.HEADERS_RECEIVED && !h && (u.statusCode = l.status, u.headers = s.parseHeaders(l.getAllResponseHeaders()), u.emit("headers", u.statusCode, u.headers, l.statusText), h = !0),
    ...
    190 : [function(e, t, r) {
        ...
        n.prototype.hashBuffer = function() {
            ...
            t = e.buffer,
            r = e.state,
            n = r[0], i = r[1], o = r[2], a = r[3], u = r[4], c = r[5], l = r[6], h = r[7], f = 0; f < 64; f++) {
                if (f < 16) this.temp[f] = (255 & t[4 * f]) << 24 | (255 & t[4 * f + 1]) << 16 | (255 & t[4 * f + 2]) << 8 | 255 & t[4 * f + 3];
                    ...
                    this.temp[f] = (d + this.temp[f - 7] | 0) + (y + this.temp[f - 16] | 0)
                }
                var v = (((u >>> 6 | u << 26) ^ (u >>> 11 | u << 21) ^ (u >>> 25 | u << 7)) + (u & c ^ ~u & l) | 0) + (h + (s[f] + this.temp[f] | 0) | 0) | 0,
    ...
    156 : [function(e, t, r) {
        ...
        n.prototype.parse = function(e, t, r) {
            ...
            if (r || i || n.match(/^\/\/[^@\/]+@[^@\/]+/)) {
                var s = "//" === n.substr(0, 2); ! s || i && E[i] || (n = n.substr(2), this.slashes = !0)
            }
            if (!E[i] && (s || i && !S[i])) {
                for (var a = -1,
                c = 0; c < b.length; c++) {
                    var l = n.indexOf(b[c]); - 1 !== l && ( - 1 === a || l < a) && (a = l)
                }
                var h, d;
                ...
                if (!y) for (var v = this.hostname.split(/\./), c = 0, C = v.length; c < C; c++) {
                    var T = v[c];
                    if (T && !T.match(_)) {
                        for (var R = "",
                        I = 0,
                        L = T.length; I < L; I++) T.charCodeAt(I) > 127 ? R += "x": R += T[I];
                        if (!R.match(_)) {
                            var O = v.slice(0, c),
                            k = v.slice(c + 1),
                            j = T.match(w);
                            j && (O.push(j[1]), k.unshift(j[2])),
                            k.length && (n = "/" + k.join(".") + n),
                ...
                if (this.hostname.length > 255 ? this.hostname = "": this.hostname = this.hostname.toLowerCase(), !y) {
                    for (var P = this.hostname.split("."), D = [], c = 0; c < P.length; ++c) {
                        var q = P[c];
                ...
                this.host = U + M,
                this.href += this.host,
                y && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== n[0] && (n = "/" + n))
            }
            if (!x[o]) for (var c = 0,
            C = m.length; c < C; c++) {
                var N = m[c],
            ...
            var H = n.indexOf("?");
            if ( - 1 !== H ? (this.search = n.substr(H), this.query = n.substr(H + 1), t && (this.query = A.parse(this.query)), n = n.slice(0, H)) : t && (this.search = "", this.query = {}), n && (this.pathname = n), S[o] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                var M = this.pathname || "",
                q = this.search || "";
                this.path = M + q
            }
        ...
        n.prototype.format = function() {
            ...
            this.query && c(this.query) && Object.keys(this.query).length && (o = A.stringify(this.query));
            var s = this.search || o && "?" + o || "";
            return t && ":" !== t.substr( - 1) && (t += ":"),
            this.slashes || (!t || S[t]) && !1 !== i ? (i = "//" + (i || ""), r && "/" !== r.charAt(0) && (r = "/" + r)) : i || (i = ""),
            n && "#" !== n.charAt(0) && (n = "#" + n),
            s && "?" !== s.charAt(0) && (s = "?" + s),
            r = r.replace(/[?#]/g,
            function(e) {
        ...
        n.prototype.resolveObject = function(e) {
            ...
            S[r.protocol] && r.hostname && !r.pathname && (r.path = r.pathname = "/"),
            r.href = r.format(),
            r;
            ...
            if (y && (r.hostname = "", r.port = null, r.host && ("" === d[0] ? d[0] = r.host: d.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === i[0] ? i[0] = e.host: i.unshift(e.host)), e.host = null), f = f && ("" === i[0] || "" === d[0])), c) r.host = e.host || "" === e.host ? e.host: r.host,
            ...
            r.href = r.format(),
            r;
            for (var m = d.slice( - 1)[0], g = (r.host || e.host) && ("." === m || ".." === m) || "" === m, b = 0, _ = d.length; _ >= 0; _--) m = d[_],
            "." == m ? d.splice(_, 1) : ".." === m ? (d.splice(_, 1), b++) : b && (d.splice(_, 1), b--);
            if (!f && !p) for (; b--; b) d.unshift(".."); ! f || "" === d[0] || d[0] && "/" === d[0].charAt(0) || d.unshift(""),
    ...
    153 : [function(e, t, r) {
        ...
        t.exports = function(e, t, r, i) {
            ...
            for (var c = 0; c < u; ++c) {
                ...
                n(o, f) ? Array.isArray(o[f]) ? o[f].push(p) : o[f] = [o[f], p] : o[f] = p
            }
            return o
        }
    },
    ...
    150 : [function(e, t, r) {
        ...
        t.exports = function(e, t, r, o) {
            ...
            for (var l = 0; l < c; ++l) {
                ...
                v = y.indexOf(r);
                v >= 0 ? (h = y.substr(0, v), f = y.substr(v + 1)) : (h = y, f = ""),
                p = decodeURIComponent(h),
    ...
    149 : [function(e, t, r) { (function(e) { !
            function(n) {
                ...
                function h(e, t, r) {
                    var n = 0;
                    for (e = r ? D(e / C) : e >> 1, e += D(e / t); e > P * S >> 1; n += x) e = D(e / P);
                    return D(n + (P + 1) * e / (e + A))
                }
                function f(e) {
                    ...
                    g = R,
                    b = T;
                    for (r = e.lastIndexOf(I), r < 0 && (r = 0), n = 0; n < r; ++n) e.charCodeAt(n) >= 128 && i("not-basic"),
                    y.push(e.charCodeAt(n));
                    for (o = r > 0 ? r + 1 : 0; o < v;) {
                        for (s = m, a = 1, l = x; o >= v && i("invalid-input"), f = c(e.charCodeAt(o++)), (f >= x || f > D((w - m) / a)) && i("overflow"), m += f * a, p = l <= b ? E: l >= b + S ? S: l - b, !(f < p); l += x) d = x - p,
                        a > D(w / d) && i("overflow"),
                        a *= d;
                        t = y.length + 1,
                        b = h(m - s, t, 0 == s),
                        D(m / t) > w - g && i("overflow"),
                        g += D(m / t),
                        m %= t,
                        y.splice(m++, 0, g)
                    }
                ...
                function p(e) {
                    var t, r, n, o, s, u, c, f, p, d, y, v, m, g, b, _ = [];
                    for (e = a(e), v = e.length, t = R, r = 0, s = T, u = 0; u < v; ++u)(y = e[u]) < 128 && _.push(q(y));
                    for (n = o = _.length, o && _.push(I); n < v;) {
                        for (c = w, u = 0; u < v; ++u)(y = e[u]) >= t && y < c && (c = y);
                        for (m = n + 1, c - t > D((w - r) / m) && i("overflow"), r += (c - t) * m, t = c, u = 0; u < v; ++u) if (y = e[u], y < t && ++r > w && i("overflow"), y == t) {
                            for (f = r, p = x; d = p <= s ? E: p >= s + S ? S: p - s, !(f < d); p += x) b = f - d,
                            g = x - d,
                            _.push(q(l(d + b % g, 0))),
                            f = D(b / g);
                            _.push(q(l(f, 0))),
                ...
                else if (v && m) if (t.exports == v) m.exports = b;
                else for (_ in b) b.hasOwnProperty(_) && (v[_] = b[_]);
                else n.punycode = b
            } (this)
        }).call(this, "undefined" != typeof global ? global: "undefined" != typeof self ? self: "undefined" != typeof window ? window: {})
    },
    ...
    3 : [function(e, t, r) { (function(t) {
            ...
            function b(e, t, r, n, i) {
                ...
                o.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? i ? Uint8Array.prototype.indexOf.call(e, t, r) : Uint8Array.prototype.lastIndexOf.call(e, t, r) : _(e, [t], r, n, i);
                ...
                for (var n = [], i = t; i < r;) {
                    ...
                    if (i + a <= r) {
                        ...
                        case 3:
                            u = e[i + 1],
                            c = e[i + 2],
                            128 == (192 & u) && 128 == (192 & c) && (h = (15 & o) << 12 | (63 & u) << 6 | 63 & c) > 2047 && (h < 55296 || h > 57343) && (s = h);
                            break;
                        case 4:
                            u = e[i + 1],
                            c = e[i + 2],
            ...
            o.compare = function(e, t) {
                ...
                n = t.length,
                i = 0,
                s = Math.min(r, n); i < s; ++i) if (e[i] !== t[i]) {
                    r = e[i],
                    n = t[i];
                    break
                }
            ...
            o.prototype.compare = function(e, t, r, n, i) {
                ...
                for (var s = i - n,
                a = r - t,
                u = Math.min(s, a), c = this.slice(n, i), l = e.slice(t, r), h = 0; h < u; ++h) if (c[h] !== l[h]) {
                    s = c[h],
                    a = l[h];
                    break
                }
            ...
            o.prototype.writeUInt16LE = function(e, t, r) {
                ...
                o.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : q(this, e, t, !0),
                t + 2
            },
            o.prototype.writeUInt16BE = function(e, t, r) {
                ...
                t |= 0,
                r || D(this, e, t, 2, 65535, 0),
                o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : q(this, e, t, !1),
                t + 2
            },
    ...
    1 : [function(e, t, r) {
        ...
        function o(e) {
            ...
            r = o > 0 ? a - 4 : a;
            var u = 0;
            for (t = 0; t < r; t += 4) i = l[e.charCodeAt(t)] << 18 | l[e.charCodeAt(t + 1)] << 12 | l[e.charCodeAt(t + 2)] << 6 | l[e.charCodeAt(t + 3)],
            s[u++] = i >> 16 & 255,
            s[u++] = i >> 8 & 255,
            s[u++] = 255 & i;
            return 2 === o ? (i = l[e.charCodeAt(t)] << 2 | l[e.charCodeAt(t + 1)] >> 4, s[u++] = 255 & i) : 1 === o && (i = l[e.charCodeAt(t)] << 10 | l[e.charCodeAt(t + 1)] << 4 | l[e.charCodeAt(t + 2)] >> 2, s[u++] = i >> 8 & 255, s[u++] = 255 & i),
            s
        }
        function s(e) {
        ...
        function u(e) {
            ...
            n = r % 3,
            i = "",
            o = [], s = 0, u = r - n; s < u; s += 16383) o.push(a(e, s, s + 16383 > u ? u: s + 16383));
        ...
        r.toByteArray = o,
        r.fromByteArray = u;
        for (var c = [], l = [], h = "undefined" != typeof Uint8Array ? Uint8Array: Array, f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", p = 0, d = f.length; p < d; ++p) c[p] = f[p],
        l[f.charCodeAt(p)] = p;
        l["-".charCodeAt(0)] = 62,
        l["_".charCodeAt(0)] = 63
    },
    ...
    248 : [function(e, t, r) {
        ...
        i.util.update(i.S3.prototype, {
            ...
            shouldDisableBodySigning: function(e) {
                ...
                return ! 0 === this.config.s3DisableBodySigning && t === i.Signers.V4 && "https:" === e.httpRequest.endpoint.protocol
            },
            setupRequestListeners: function(e) {
                ...
                e.addListener("validate", this.validateBucketName),
                ...
                this.shouldDisableBodySigning(e) && (e.removeListener("afterBuild", i.EventListeners.Core.COMPUTE_SHA256), e.addListener("afterBuild", this.disableBodySigning))
            },
            validateScheme: function(e) {
                var t = e.params,
                r = e.httpRequest.endpoint.protocol;
                if ((t.SSECustomerKey || t.CopySourceSSECustomerKey) && "https:" !== r) throw i.util.error(new Error, {
                    code: "ConfigError",
            ...
            validateBucketName: function(e) {
                if ("v4" === e.service.getSignatureVersion(e)) {
                    var t = e.params && e.params.Bucket,
                    r = e.params && e.params.Key,
                    n = t && t.indexOf("/");
                    if (t && n >= 0) {
                        if ("string" != typeof r) {
                            var a = "Bucket names cannot contain forward slashes. Bucket: " + t;
                            throw i.util.error(new Error, {
                                code: "InvalidBucket",
                                message: a
                            })
            ...
            populateURI: function(e) {
                ...
                if (r && !i.pathStyleBucketName(r)) {
                    i.config.useAccelerateEndpoint && i.isValidAccelerateOperation(e.operation) ? i.config.useDualstack ? n.hostname = r + ".s3-accelerate.dualstack.amazonaws.com": n.hostname = r + ".s3-accelerate.amazonaws.com": i.config.s3BucketEndpoint || (n.hostname = r + "." + n.hostname);
                    var a = n.port;
            ...
            removeVirtualHostedBucketFromPath: function(e) {
                ...
                r && t.path && (t.path = t.path.replace(new RegExp("/" + r), ""), "/" !== t.path[0] && (t.path = "/" + t.path))
            },
            addExpect100Continue: function(e) {
                var t = e.httpRequest.headers["Content-Length"];
                i.util.isNode() && t >= 1048576 && (e.httpRequest.headers.Expect = "100-continue")
            },
            addContentType: function(e) {
                ...
                if (i.util.isBrowser()) if ("string" != typeof t.body || r.match(/;\s*charset=/)) {
            ...
            willComputeChecksums: function(e) {
                ...
                if (!i.util.Buffer.isBuffer(e.httpRequest.body) && "string" != typeof e.httpRequest.body) return ! 1;
                var t = e.service.api.operations[e.operation].input.members;
                return ! (!e.service.shouldDisableBodySigning(e) || Object.prototype.hasOwnProperty.call(e.httpRequest.headers, "presigned-expires") || !t.ContentMD5 || e.params.ContentMD5) || !(e.service.getSignerClass(e) === i.Signers.V4 && t.ContentMD5 && !t.ContentMD5.required) && (!(!t.ContentMD5 || e.params.ContentMD5) || void 0)
            },
            ...
            dnsCompatibleBucketName: function(e) {
                ...
                i = new RegExp(/(\d+\.){3}\d+/),
                n = new RegExp(/\.\./);
                return ! (!t.match(r) || t.match(i) || t.match(n))
            },
            successfulResponse: function(e) {
                var t = e.request,
                r = e.httpResponse;
            ...
            updateReqBucketRegion: function(e, t) {
                ...
                if ("string" == typeof t && t.length && (r.region = t), r.endpoint.host.match(/s3(?!-accelerate).*\.amazonaws\.com$/)) {
                    ...
                    "validate" === e._asm.currentState && (e.removeListener("build", n.populateURI), e.addListener("build", n.removeVirtualHostedBucketFromPath))
                }
            },
            extractData: function(e) {
                ...
                if ("deleteBucket" !== t.operation || "string" != typeof i || e.error) {
                    ...
                    a && i && a !== t.service.bucketRegionCache[i] && (t.service.bucketRegionCache[i] = a)
            ...
            extractError: function(e) {
                ...
                s && u && s !== c[u] && (c[u] = s);
                var l;
                if (t[n] && 0 === a.length) u && !s && (l = c[u] || null) !== r.httpRequest.region && (s = l),
                e.error = i.util.error(new Error, {
                    ...
                    var p = (new i.XML.Parser).parse(a.toString());
            ...
            requestBucketRegion: function(e, t) {
                ...
                if (!r || !a || r.region || "listObjects" === n.operation || i.util.isNode() && "headBucket" === n.operation || 400 === r.statusCode && "headObject" !== n.operation || -1 === o.indexOf(r.code)) return t();
                var s = i.util.isNode() ? "headBucket": "listObjects",
                u = {
                    Bucket: a
                };
            ...
            reqRegionForNetworkingError: function(e, t) {
                ...
                n = e.request,
                a = n.params.Bucket;
                if (!r || "NetworkingError" !== r.code || !a || "us-east-1" === n.httpRequest.region) return t();
                var o = n.service,
                s = o.bucketRegionCache,
                u = s[a] || null;
                if (u && u !== n.httpRequest.region) o.updateReqBucketRegion(n, u),
                t();
                else if (o.dnsCompatibleBucketName(a)) if (n.httpRequest.virtualHostedBucket) {
                    var c = o.listObjects({
                        Bucket: a,
                        MaxKeys: 0
                    });
                    ...
                    c.send(function() {
                        ...
                        e && e !== n.httpRequest.region && o.updateReqBucketRegion(n, e),
                        t()
                    })
                } else t();
                else o.updateReqBucketRegion(n, "us-east-1"),
            ...
            preparePostFields: function(e, t, r, a, o, s) {
                ...
                a["X-Amz-Signature"] = i.util.crypto.hmac(n.getSigningKey(e, l, t, "s3", !0), a.Policy, "hex"),
                a
            },
            preparePostPolicy: function(e, t) {
                return i.util.base64.encode(JSON.stringify({
                    expiration: i.util.date.iso8601(e),
                    conditions: t
                }))
            },
            prepareSignedUrl: function(e) {
                ...
                e.params.Body ? e.addListener("afterBuild", i.EventListeners.Core.COMPUTE_SHA256) : e.removeListener("build", e.service.computeContentMd5)
            },
            ...
            noPresignedContentLength: function(e) {
                if (void 0 !== e.params.ContentLength) throw i.util.error(new Error, {
            ...
            upload: function(e, t, r) {
                ...
                return "function" == typeof r && n.send(r),
                n
            }
        })
    },
        ...
        i.S3.ManagedUpload = i.util.inherit({
            ...
            send: function(e) {
                ...
                if (t.sliceFn) t.fillQueue = t.fillBuffer;
                    ...
                    t.body instanceof n && (r = !1, t.fillQueue = t.fillStream, t.partBuffers = [], t.body.on("error",
                    function(e) {
                        t.cleanup(e)
                    }).on("readable",
                    function() {
            ...
            abort: function() {
                this.cleanup(i.util.error(new Error("Request aborted by user"), {
                    code: "RequestAbortedError",
                    retryable: !1
                }))
            },
            validateBody: function() {
                var e = this;
                if (e.body = e.service.config.params.Body, "string" == typeof e.body) e.body = new i.util.Buffer(e.body);
            ...
            bindServiceObject: function(e) {
                ...
                if (t.service) {
                    ...
                    t.service.config.params = i.util.merge(t.service.config.params || {},
                    e)
                } else t.service = new i.S3({
                    params: e
                })
            },
            ...
            fillBuffer: function() {
                ...
                for (; e.activeParts < e.queueSize && e.partPos < t;) {
                    ...
                    (n(i) < e.partSize || e.partPos === t) && (e.isDoneChunking = !0, e.numParts = e.totalPartNumbers + 1),
                    e.nextChunk(i)
                }
            },
            fillStream: function() {
            ...
            nextChunk: function(e) {
                ...
                if (t.service.config.params.ContentMD5) {
                    var o = i.util.error(new Error("The Content-MD5 you specified is invalid for multi-part uploads."), {
                        code: "InvalidDigest",
                        retryable: !1
                    });
                    return t.cleanup(o),
            ...
            getTaggingHeader: function() {
                for (var e = [], t = 0; t < this.tags.length; t++) e.push(i.util.uriEscape(this.tags[t].Key) + "=" + i.util.uriEscape(this.tags[t].Value));
                return e.join("&")
            },
            uploadPart: function(e, t) {
                ...
                n = {
                    Body: e,
                    ContentLength: i.util.string.byteLength(e),
                    PartNumber: t
                },
                a = {
                    ETag: null,
                ...
                o.send(function(e, t) {
                    if (delete r.parts[n.PartNumber], r.activeParts--, !(e || t && t.ETag)) {
                        var o = "No access to ETag property on response.";
                        i.util.isBrowser() && (o += " Check CORS configuration to expose ETag header."),
                        e = i.util.error(new Error(o), {
                            code: "ETagMissing",
                            retryable: !1
                        })
                    }
                    if (e) return r.cleanup(e);
                    a.ETag = t.ETag,
                    r.doneParts++,
                    r.isDoneChunking && r.doneParts === r.numParts ? r.finishMultiPart() : r.fillQueue.call(r)
                })
            },
            ...
            finishMultiPart: function() {
                ...
                function(t, r) {
                    ...
                    r && "string" == typeof r.Location && (r.Location = r.Location.replace(/%2F/g, "/")),
                    Array.isArray(e.tags) ? e.service.putObjectTagging({
                        Tagging: {
                            TagSet: e.tags
                        }
                    },
        ...
        CopyObject: {
            ...
            input: {
                ...
                members: {
                    ...
                    MoveSource: {
                        location: "header",
                        locationName: "X-Amz-Move-Source"
                    },
                    MoveBatchSource: {
                        location: "header",
                        locationName: "X-Amz-Move-Source-Batch"
                    },
                    CopyBatchSource: {
                        location: "header",
                        locationName: "X-Amz-Copy-Source-Batch"
                    },
                    CopySourceIfMatch: {
                        location: "header",
        ...
        HeadObject: {
            ...
            input: {
                ...
                members: {
                    ...
                    Expires:{
                      location: "header",
                      locationName: "X-Amz-Share-Expires"
                    },
                    Range: {
                        location: "header",
                        locationName: "Range"
        ...
        ListBuckets: {
            ...
            input: {
              ...
              members: {
                  FilterName: {
                      location: "header",
                      locationName: "X-Amz-TMS-Search"
                  },
                  FilterPath: {
                      location: "header",
                      locationName: "X-Amz-TMS-Subpath"
                  }
              }
            },  
            output: {
